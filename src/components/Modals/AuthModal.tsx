    ...
    <>
      ...
      <div className="w-full sm:w-[450px]  absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]  flex justify-center items-center">
        <div className="relative w-full h-full mx-auto flex items-center justify-center">
          <div className="bg-white rounded-lg shadow relative w-full bg-gradient-to-b from-brand-orange to-slate-900 mx-10 sm:mx-6">
            ...
            {authModal.type === "login" ? <Login /> : authModal.type === "register" ? <Signup /> : <Ressetpassword />}
          </div>
        </div>
      </div>
    </>
